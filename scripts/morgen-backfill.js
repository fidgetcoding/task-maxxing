 ...
 *   VAULT_PATH       Absolute path to your Obsidian 08-Tasks dir, i.e. the
 *                    dir that contains TASKS-URGENT.md etc. (or pass --vault)
 *
 * Usage:
 *   VAULT_PATH="$HOME/path/to/vault/08-Tasks" \
 *   MORGEN_API_KEY="…" \
 *     node scripts/morgen-backfill.js --dry-run
 *
 *   node scripts/morgen-backfill.js --vault "$HOME/vault/08-Tasks" --dry-run
...
REQUIRED (env or flag):
  VAULT_PATH / --vault <dir>     Absolute path to your 08-Tasks directory
